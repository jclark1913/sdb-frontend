...
export default function Example() {
  ...
  const navigation = [
    ...
    { name: 'Saved Collections', href: '/collections', current: location.pathname === '/collections' },
...
{/* {                  <img
                    ...
                    alt="Your Company"
                  />} */}
                  <h1 className="text-white text-2xl font-bold">SDB</h1>
                </div>
                ...
                <Menu as="div" className="relative ml-3">
                  <div>
                    <Menu.Button className="relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                      ...
                      <Cog8ToothIcon className="stroke-white block h-6 w-6" aria-hidden="true" />
                    </Menu.Button>
                  </div>
                  <Transition
                    as={Fragment}
